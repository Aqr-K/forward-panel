...
```bash
curl -L https://raw.githubusercontent.com/Aqr-K/forward-panel/refs/heads/main/panel_install.sh -o panel_install.sh && chmod +x panel_install.sh && ./panel_install.sh
